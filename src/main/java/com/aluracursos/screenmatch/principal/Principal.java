...
public class Principal {
    ...
    public void muestraElMenu(){
       ...
       //         .peek(e-> System.out.println("Primer filtro (N/A)"+e))
         //       .sorted(Comparator.comparing(DatosEpisodio::evaluacion).reversed())
           //     .peek(e-> System.out.println("Segundo filtro de ordenar de mayor a menor"+e))
             //   .map(e->e.titulo().toUpperCase())
               // .peek(e-> System.out.println("Tercer filtro Mayus (m<M)"+e))
               // .limit(5)
    ...
    /*    System.out.println("Por favor escriba el titulo del episodio que desea buscar");
        ...
        Optional<Episodio> episodioBuscar = episodios.stream()
                .filter(e -> e.getTitulo().toUpperCase().contains(pedazoTitulo.toUpperCase())) //trae el primero
                .findFirst();
